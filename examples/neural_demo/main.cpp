...
// Compare two vectors element-wise within an absolute tolerance.
static bool vectorsNearEqual(const std::vector<double>& a,
...
int main()
{
    ...
    bool identical = vectorsNearEqual(out1, out2);
    ...
    bool different = !vectorsNearEqual(out1, out3);
